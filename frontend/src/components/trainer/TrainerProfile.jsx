      ...
      <div className="profile-card">
        ...
        <div className="profile-header">
          <div>
            ...
            <p className="subtitle">회원들에게 보여질 트레이너 프로필 정보입니다.</p>
          </div>
        ...
        <div className="profile-form">
          ...
          <div className="form-group">
            ...
            {isEdit ? (
              ...
              <p className="read-only-text">{trainer.career || "등록된 경력이 없습니다."}</p>
            )}
          </div>
          ...
          <div className="form-group">
            ...
            {isEdit ? (
              ...
              <p className="read-only-text">{trainer.specialty || "등록된 전문 분야가 없습니다."}</p>
            )}
          </div>
          ...
          <div className="form-group">
            ...
            {isEdit ? (
              ...
              <p className="read-only-text">{trainer.certificate || "등록된 자격증 및 수상 내역이 없습니다."}</p>
            )}
          </div>
          ...
          <div className="form-group">
            ...
            {isEdit ? (
              ...
              <p className="read-only-text multiline">{trainer.introduce || "등록된 자기소개가 없습니다."}</p>
            )}
          </div>
