...
public class ProductsTest {
  ...
  void orderTest() {
    ...
    ProductEntity product1 = productRepository.findById(11L)
            .orElseThrow();

    ProductEntity product2 = productRepository.findById(12L)
            .orElseThrow();

    ProductEntity product3 = productRepository.findById(13L)
            .orElseThrow();
