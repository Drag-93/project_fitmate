...
/**
 * exercise 테이블의 한글 컬럼(name_ko, target_ko, equip_ko, body_ko)이
 * 비어있는 행들을 찾아 Google Cloud Translation API(v2, REST + API 키)로 채워주는 배치 서비스.
 *
 * 핵심 최적화:
...
public class ExerciseTranslationService {
